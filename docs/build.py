...
<div class="section">
  ...
  <div class="install-step">
    ...
    <div class="code-block"><code>Reinstall/update my `bibtidy` skill from https://github.com/mathpluscode/bibtools, discarding local changes in `~/.codex/bibtools` and replacing `~/.codex/skills/bibtidy` with the correct symlinked setup.</code><button class="copy-btn" type="button" onclick="copyCode(this)">Copy</button></div>
  </div>
